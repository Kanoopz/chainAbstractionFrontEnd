...
//   networkId: 81,
//   chainId: 81,
//   // Agrega más parámetros según sea necesario, como gasPrice, rpcURL, etc.
// };

// const customCommon = Common.forCustomChain(
//   'mainnet', // Cadena base, 'mainnet' en este caso
//   shibuyaParams
// );

// const commonShibuya = Common.custom({ chain: 'mainnet', chainId: 81,  });
const commonShibuya = Common.custom(1, { name: 'shibuya', networkId: 81, chainId: 91 }, 'istanbul');

const Shibuya = 81;
// const Eth = new Ethereum('https://rpc2.sepolia.org', Sepolia);
const Eth = new Ethereum('https://evm.shibuya.astar.network', commonShibuya);

export function AstarView({ props: { setStatus, MPC_CONTRACT, transactions } }) {
  ...
  async function submmitSignedTx()
  {
    await Eth.submmitTx(signedTransaction);
  }
  ...
  return (
    <>
      ...
      <button onClick={submmitSignedTx}>customSubmmit</button>
